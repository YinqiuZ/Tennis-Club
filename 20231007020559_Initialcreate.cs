    ...
    public partial class Initialcreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Coaches", x => x.Name);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoachName = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CoachName1 = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Schedules_Coaches_CoachName",
                        column: x => x.CoachName,
                        principalTable: "Coaches",
                        principalColumn: "Name");
                    table.ForeignKey(
                        name: "FK_Schedules_Coaches_CoachName1",
                        column: x => x.CoachName1,
                        principalTable: "Coaches",
                        principalColumn: "Name");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberSchedules", x => new { x.MemberId, x.ScheduleId });
                    table.ForeignKey(
                        name: "FK_MemberSchedules_AspNetUsers_MemberId",
                        column: x => x.MemberId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MemberSchedules_Members_MemberId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MemberSchedules_MemberId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Schedules_CoachName",
                table: "Schedules",
                column: "CoachName");

            migrationBuilder.CreateIndex(
                name: "IX_Schedules_CoachName1",
                table: "Schedules",
                column: "CoachName1");
        }
